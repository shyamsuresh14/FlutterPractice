...
class StaggeredAnimation extends StatelessWidget{
  ...
  Widget _animationWidget(BuildContext context, Widget child){
    return Container(
...
class _StaggeredAnimationWidgetState extends State<StaggeredAnimationWidget> with TickerProviderStateMixin{
